...
from nomad.metainfo.data_type import normalize_type, m_int32, m_int16, m_float32, m_float64
...
class TestBoundedNumber:
    ...
    def test_serialization_and_reconstruction(self):
        ...
        assert 'nomad_simulations.schema_packages.data_types.BoundedNumber' in serialized['type_data']
