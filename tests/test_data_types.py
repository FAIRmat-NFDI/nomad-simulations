...
class TestBoundedInt:
    ...
    def test_init_default(self):
        ...
        assert bounded_int._dtype is int
    ...
    def test_min_bound_exclusive(self):
        ...
        bounded_int = setup_datatype_for_testing(
            BoundedInt().min(5, inclusive=False), shape=None
        )
    ...
    def test_both_bounds(self):
        ...
        bounded_int = setup_datatype_for_testing(
            BoundedInt().min(5).max(10), shape=None
        )
    ...
    def test_infinity_bounds(self):
        ...
        bounded_int = setup_datatype_for_testing(
            BoundedInt().min(float('-inf')).max(float('inf')), shape=None
        )
...
class TestBoundedFloat:
    ...
    def test_init_default(self):
        ...
        assert bounded_float._dtype is float
    ...
    def test_min_bound_exclusive(self):
        ...
        bounded_float = setup_datatype_for_testing(
            BoundedFloat().min(0, inclusive=False), shape=None
        )
    ...
    def test_arrays_with_nan(self):
        ...
        bounded_float = setup_datatype_for_testing(
            BoundedFloat().min(0).max(1), shape=['*']
        )
    ...
    def test_infinity_values(self):
        ...
        bounded_float = setup_datatype_for_testing(
            BoundedFloat().min(float('-inf')), shape=None
        )
