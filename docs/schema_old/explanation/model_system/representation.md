...
```python
--8<-- "snippets/schema_old/explanation/model_system/representation/block_01.py"
```
...
```python
--8<-- "snippets/schema_old/explanation/model_system/representation/block_02.py"
```
...
```python
--8<-- "snippets/schema_old/explanation/model_system/representation/block_03.py"
```
...
```python
--8<-- "snippets/schema_old/explanation/model_system/representation/block_04.py"
```
...
```python
--8<-- "snippets/schema_old/explanation/model_system/representation/block_05.py"
```
...
```python
--8<-- "snippets/schema_old/explanation/model_system/representation/block_06.py"
```
