...
```python
--8<-- "snippets/schema_old/explanation/model_system/model_system/block_01.py"
```
...
```python
--8<-- "snippets/schema_old/explanation/model_system/model_system/block_02.py"
```
...
```python
--8<-- "snippets/schema_old/explanation/model_system/model_system/block_03.py"
```
...
```python
--8<-- "snippets/schema_old/explanation/model_system/model_system/block_04.py"
```
...
```python
--8<-- "snippets/schema_old/explanation/model_system/model_system/block_05.py"
```

### Working with Alternative Representations

```python
--8<-- "snippets/schema_old/explanation/model_system/model_system/block_06.py"
```

### Heterostructure with Sub-systems

```python
--8<-- "snippets/schema_old/explanation/model_system/model_system/block_07.py"
```
