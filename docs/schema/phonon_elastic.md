...
**Purpose.** Lattice dynamics models and results, elastic tensors, and Hessians.**In scope:** phonon dispersions, force constants, elastic constants**Out of scope:** thermo integration over phonons (see Thermodynamics)
## Relationship map
