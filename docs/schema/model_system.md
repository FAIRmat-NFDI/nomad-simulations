...
| `total_multiplicity` | m_int_bounded(int32) | <details><summary>Spin multiplicity **2S+1** of the total system.</summary>Spin multiplicity **2S+1** of the total system.<br>Here S is the total spin quantum number, so the value describes the system-level<br>total electronic state and is always a strictly positive integer:<br>singlet → 1, doublet → 2, triplet → 3</details> |
