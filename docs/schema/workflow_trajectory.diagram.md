# Workflow Trajectory Properties - Full Screen Diagram
...
classDiagram
    ...
    SerialWorkflowResults *-- FreeEnergyCalculations
    SerialWorkflowResults *-- Pressures
    SerialWorkflowResults *-- RadiiOfGyration
    SerialWorkflowResults *-- Temperatures
```
