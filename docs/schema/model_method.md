...
| Quantity | Type | Description |
|---|---|---|
| `orbital_1` | <nomad.metainfo.metainfo.Reference object at 0x7601b8f707d0> | Reference to the first `OrbitalsState` section. |
| `orbital_2` | <nomad.metainfo.metainfo.Reference object at 0x7601b8f70650> | Reference to the second `OrbitalsState` section. |
...
| `screening_ref` | <nomad.metainfo.metainfo.Reference object at 0x7601b8f72090> | Reference to the `Screening` section that the GW calculation used to obtain the screened Coulomb interactions. |
...
| `screening_ref` | <nomad.metainfo.metainfo.Reference object at 0x7601b8f700e0> | Reference to the `Screening` section that the BSE calculation used to obtain the screened Coulomb interactions. |
...
| `core_hole_ref` | <nomad.metainfo.metainfo.Reference object at 0x7601b8f710a0> | Reference to the `CoreHole` section that contains the information of the edge of the excited core-hole. |
| `excited_state_method_ref` | <nomad.metainfo.metainfo.Reference object at 0x7601b8f70f20> | Reference to the `ModelMethodElectronic` section (e.g., `DFT` or `BSE`) that was used to obtain the core-hole spectra. |
