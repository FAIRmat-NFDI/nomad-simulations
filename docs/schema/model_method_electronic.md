...
- Non-electronic ModelMethod subclasses
- Method parameter detail sections not in this inheritance branch
- Numerical settings and output properties
...
| `screening_ref` | <nomad.metainfo.metainfo.Reference object at 0x7326b1ec2450> | Reference to the `Screening` section that the GW calculation used to obtain the screened Coulomb interactions. |
...
| `screening_ref` | <nomad.metainfo.metainfo.Reference object at 0x7326b1e9bad0> | Reference to the `Screening` section that the BSE calculation used to obtain the screened Coulomb interactions. |
...
| `field_polarization_ref` | <nomad.metainfo.metainfo.Reference object at 0x7326b215b170> | External field / polarization used to drive the response or propagation. |
...
| `core_hole_ref` | <nomad.metainfo.metainfo.Reference object at 0x7326b1ec1d60> | Reference to the `CoreHole` section that contains the information of the edge of the excited core-hole. |
| `excited_state_method_ref` | <nomad.metainfo.metainfo.Reference object at 0x7326b1ec1c40> | Reference to the `ModelMethodElectronic` section (e.g., `DFT` or `BSE`) that was used to obtain the core-hole spectra. |
