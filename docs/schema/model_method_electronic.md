...
| `screening_ref` | <nomad.metainfo.metainfo.Reference object at 0x7b28dcab8e60> | Reference to the `Screening` section that the GW calculation used to obtain the screened Coulomb interactions. |
...
| `screening_ref` | <nomad.metainfo.metainfo.Reference object at 0x7b28dca93fe0> | Reference to the `Screening` section that the BSE calculation used to obtain the screened Coulomb interactions. |
...
| `field_polarization_ref` | <nomad.metainfo.metainfo.Reference object at 0x7b28dcd52900> | External field / polarization used to drive the response or propagation. |
...
| `core_hole_ref` | <nomad.metainfo.metainfo.Reference object at 0x7b28dcab9ca0> | Reference to the `CoreHole` section that contains the information of the edge of the excited core-hole. |
| `excited_state_method_ref` | <nomad.metainfo.metainfo.Reference object at 0x7b28dcab9cd0> | Reference to the `ModelMethodElectronic` section (e.g., `DFT` or `BSE`) that was used to obtain the core-hole spectra. |
