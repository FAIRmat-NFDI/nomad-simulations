...
| `screening_ref` | <nomad.metainfo.metainfo.Reference object at 0x7105cf6275c0> | Reference to the `Screening` section that the GW calculation used to obtain the screened Coulomb interactions. |
...
| `screening_ref` | <nomad.metainfo.metainfo.Reference object at 0x7105cf603a40> | Reference to the `Screening` section that the BSE calculation used to obtain the screened Coulomb interactions. |
...
| `field_polarization_ref` | <nomad.metainfo.metainfo.Reference object at 0x7105cf6275f0> | External field / polarization used to drive the response or propagation. |
...
| `core_hole_ref` | <nomad.metainfo.metainfo.Reference object at 0x7105cf6249e0> | Reference to the `CoreHole` section that contains the information of the edge of the excited core-hole. |
| `excited_state_method_ref` | <nomad.metainfo.metainfo.Reference object at 0x7105cf624a10> | Reference to the `ModelMethodElectronic` section (e.g., `DFT` or `BSE`) that was used to obtain the core-hole spectra. |
