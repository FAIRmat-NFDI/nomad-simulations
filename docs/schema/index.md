...
**Key sections:** ModelMethodElectronic, ElectronicResponseMethod, DFT, TB, xTB, Wannier, SlaterKoster, ExcitedStateMethodology, Screening, GW, BSE, TDDFT, HF, CC, EOMCC, CI, ADC, PerturbationMethod, CoreHoleSpectra, DMFT
